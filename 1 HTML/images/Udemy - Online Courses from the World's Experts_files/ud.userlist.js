 ...
 */
define(["jquery-widget-init", "handlebars.helpers", "handlebars-templates", "ud-link",
    "jquery.fancybox", "jquery.ba-throttle-debounce",
    "ud.api", "ud.api.v2", "ud.initializer"
], function($, Handlebars, handlebarsTemplates, udLink) {
    ...
    $.widget('ud.ud_userlist', {
        ...
        _initHandlebarsTemplates: function() {
            this.userTemplate = handlebarsTemplates['course/student'];
            this.courseStudentListTemplate = handlebarsTemplates['course/student-list'];
        },
        _initUI: function() {
            ...
            if(this.extendedHandlebarsHelpers===null){
                var localHelpers = {
                    generateMessageUrl : function(userId) {
                        return udLink.to("message", "send", {user_id:$.trim(userId)});
                    }
                };
